...
#ifndef VERIFYKIT_SWIFT_H
#define VERIFYKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VerifyKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC9VerifyKit31CountryCodePickerViewController")
...
@interface CountryCodePickerViewController (SWIFT_EXTENSION(VerifyKit))
@end

@class UISearchController;
@interface CountryCodePickerViewController (SWIFT_EXTENSION(VerifyKit)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end

SWIFT_CLASS("_TtC9VerifyKit20PhoneNumberFormatter")
...
@interface PhoneNumberFormatter (SWIFT_EXTENSION(VerifyKit))
...
SWIFT_CLASS("_TtC9VerifyKit20PhoneNumberTextField")
...
@interface PhoneNumberTextField (SWIFT_EXTENSION(VerifyKit))
...
typedef SWIFT_ENUM(NSInteger, VerifyKitEnvironment, open) {
/// Stage environment for debug
  VerifyKitEnvironmentDebug = 0,
/// Production environment
  VerifyKitEnvironmentRelease = 1,
};
...
SWIFT_CLASS("_TtC9VerifyKit17VerifyKitInstance")
@interface VerifyKitInstance : NSObject
/// Initialize VerifyKit with default options
/// environment: .debug - logActive: true - theme: default
/// *
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (UIViewController <VerifyKitObjCViewController> * _Nonnull)viewControllerForLogin_objC SWIFT_WARN_UNUSED_RESULT;
...
+ (void)checkInterruptedSessionWithCompletion:(void (^ _Nonnull)(NSString * _Nullable))completion;
/// Forward Telegram Login callbacks delivered as opened URLs (custom-scheme fallback).
/// Call this from <code>scene(_:openURLContexts:)</code> (iOS 13+) or
/// <code>application(_:open:options:)</code> (iOS <13) on the host app.
/// \param openURL The URL passed in by iOS.
///
///
/// returns:
/// <code>true</code> if the SDK consumed the URL (it matches the configured Telegram
/// redirect URI). <code>false</code> otherwise — the integrator should keep handling the URL.
+ (BOOL)handleWithOpenURL:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
/// Forward Telegram Login callbacks delivered as Universal Links (NSUserActivity).
/// Call this from <code>scene(_:continue:)</code> or
/// <code>application(_:continue:restorationHandler:)</code> on the host app.
/// \param userActivity The activity passed in by iOS.
///
///
/// returns:
/// <code>true</code> if the SDK consumed the activity’s web URL. <code>false</code> otherwise.
+ (BOOL)handleWithContinue:(NSUserActivity * _Nonnull)userActivity SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC9VerifyKit16VerifyKitNSError")
@interface VerifyKitNSError : NSError
...
SWIFT_PROTOCOL("_TtP9VerifyKit21VerifyKitObjCDelegate_")
